...
<body>
    <div class="container-fluid">
        ...
        <h4 class="text-center report-title">Laporan Data Barang Point Motor</h4>
        <p class="text-center report-date">{{(date('d-M-Y', strtotime($tgl_mulai)))}} s.d
            {{(date('d-M-Y', strtotime($tgl_akhir)))}}</p>
